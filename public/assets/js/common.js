...
$(window).on("load resize",function(e){
  $('.chat-box').css('max-height', (window.innerHeight) - 320);
  $('.chat-box').css('min-height', (window.innerHeight) - 320);
});

$(window).on("load resize",function(e){
  $('.users-container .users').css('max-height', (window.innerHeight) - 320);
});
